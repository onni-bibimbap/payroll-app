...
RM5,800.01-5,900.00 band is RM102.35/RM73.10 while this formula yields
RM102.40/RM73.15. The legislated table is discrete bracket amounts, not a
continuous formula, so a handful of bands may be off by 5 sen. For guaranteed
exactness across every band, replace this with a hardcoded lookup table
sourced from the official PDF instead of a formula.
"""
